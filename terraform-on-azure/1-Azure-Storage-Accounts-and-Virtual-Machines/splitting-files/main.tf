...
resource "azurerm_windows_virtual_machine" "appvm" {
  ...
  network_interface_ids = [
    ...
    azurerm_network_interface.secondaryappinterface.id
  ]
  ...
  depends_on = [ 
    ...
    azurerm_network_interface.secondaryappinterface,
    azurerm_resource_group.appgrp
   ]
}

resource "azurerm_network_interface" "secondaryappinterface" {
  name                = "secondaryappinterface"
  location            = local.location
  resource_group_name = local.resource_group_name
